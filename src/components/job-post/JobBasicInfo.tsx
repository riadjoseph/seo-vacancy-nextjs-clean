...
export const CITIES_BY_COUNTRY = {
  Remote: ['Remote'],
  'United Kingdom': ['London', 'Manchester', 'Birmingham', 'Liverpool', 'Edinburgh', 'Glasgow', 'Bristol', 'Leeds', 'Sheffield', 'Cardiff', 'Cambridge', 'Leicester', 'Southampton', 'Oxford', 'Bournemouth'],
  Ireland: ['Dublin', 'Cork'],
  ...
  Spain: ['Córdoba', 'Valladolid', 'Vigo', 'Gijón', 'La Coruña', 'Santander', 'Pamplona', 'Cádiz', 'Salamanca', 'Almería', 'Murcia', 'Madrid', 'Barcelona', 'Valencia', 'Seville', 'Zaragoza', 'Málaga', 'Bilbao', 'Alicante', 'Granada', 'Palma'],
  Portugal: ['Lisbon', 'Porto', 'Braga', 'Coimbra', 'Funchal', 'Setúbal', 'Aveiro', 'Faro', 'Évora', 'Guimarães'],
  Germany: ['Aachen', 'Bremen', 'Hanover', 'Nuremberg', 'Dresden', 'Bochum', 'Wuppertal', 'Bielefeld', 'Bonn', 'Mannheim', 'Karlsruhe', 'Erfurt', 'Erlangen', 'Kassel', 'Ingolstadt', 'Magdeburg', 'Paderborn', 'Regensburg', 'Rostock', 'Berlin', 'Hamburg', 'Munich', 'Cologne', 'Frankfurt', 'Stuttgart', 'Düsseldorf', 'Dusseldorf', 'Leipzig', 'Dortmund', 'Essen'],
  Italy: ['Verona', 'Messina', 'Padua', 'Trieste', 'Taranto', 'Brescia', 'Prato', 'Parma', 'Modena', 'Reggio Calabria', 'Rome', 'Milan', 'Naples', 'Turin', 'Torino', 'Palermo', 'Genoa', 'Bologna', 'Florence', 'Bari', 'Venice'],
  Belgium: ['Aalst', 'Charleroi', 'Eupen', 'Namur', 'Mons', 'Hasselt', 'Mechelen', 'Kortrijk', 'Tournai', 'Brussels', 'Leuven', 'Antwerp', 'Ghent', 'Bruges', 'Liège'],
  Switzerland: ['Lugano', 'Winterthur', 'Lucerne', 'St. Gallen', 'Thun', 'Zurich', 'Geneva', 'Basel', 'Lausanne', 'Bern'],
  Netherlands: ['Tilburg', 'Haarlem', 'Groningen', 'Nijmegen', 'Maastricht', 'Amersfoort', 'Amsterdam', 'Rotterdam', 'The Hague', 'Utrecht', 'Eindhoven'],
